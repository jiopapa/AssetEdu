...
public class RealAcntController {
	@Autowired
	Jnl14RealAcntMapService jnl14RealAcntMapService;
	...
	public String list(String searchText
		...
		Long totalItemCount = jnl14RealAcntMapService.selectCount(queryAttr);
		...
		List<Jnl14RealAcntMap> list = jnl14RealAcntMapService.selectList(queryAttr);
		model.addAttribute("list", list);
		model.addAttribute("pageAttr", pageAttr);
		model.addAttribute("searchText", searchText);
		return "/jnl/real-acnt/real_acnt_list";
	}
