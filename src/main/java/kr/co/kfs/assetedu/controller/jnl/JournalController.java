...
public class JournalController {
	@Autowired
	Jnl01JournalService jnl01JournalService;
	...
	public String list(String searchText
		...
		Long totalItemCount = jnl01JournalService.selectCount(queryAttr);
		...
		List<Jnl01Journal> list = jnl01JournalService.selectList(queryAttr);
		...
		return "/jnl/journal/journalList";
	}
