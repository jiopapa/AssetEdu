        ...
        <form:form action="/item/insert" method="POST" modelAttribute="item" class="validcheck" >
            <table class="table table-sm table-borderless">
                ...
                <tr class="align-middle">
                    ...
                    <td>
                        <form:select path="itm01ListType" class="form-select" placeholder = "선택">
                ...
                <tr class="align-middle">
                    ...
                    <td>
                        <form:select path="itm01MarketType" class="form-select"  placeholder = "선택">
                            <form:option value="선택" />
                ...
                <tr class="align-middle">
                    ...
                    <td>
                        ...
                        <form:input type="text" class="form-control bg-light" path="itm01IssType" readonly="true" 
...
$(document).ready(function () {
    ...
    $('#btnPopupCorp').on('click', function(){
        var url = '/popup/corp?corpCd=itm01IssCoCd&corpNm=itm01IssType';
        var prop = {};
        var width = 720;
        var height = 650;
