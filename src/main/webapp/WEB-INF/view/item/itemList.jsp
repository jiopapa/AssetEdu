    ...
    <table class="table table-sm table-hover mt-3 itemTable" style="font-size:small">
      <thead class="table-light">
        <tr class="text-center">
          ...
          <th scope="col" style="width:250px">종목한글명</th>
          <th scope="col" style="width:200px">종목영문명</th>
          <th scope="col" style="width:85px">단축코드</th>
          <th scope="col" style="width:50px">증권종류</th>
          <th scope="col" style="width:50px">상장구분</th>
          <th scope="col" style="width:50px">시장구분</th>
