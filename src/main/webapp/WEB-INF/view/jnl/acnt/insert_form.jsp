        ...
        <form:form action="/jnl/acnt/insert" method="POST" modelAttribute="jnl10Acnt" class="validcheck" >
            <table class="table table-sm table-borderless" >
                <tr class="align-middle">
                    ...
                    <td ><form:input type="text" class="form-control" path="jnl10AcntCd"  data-v-min-length="7" maxlength="7" required="true" style="width:200px" /></td>
                </tr>
                <tr class="align-middle">
                ...
                <tr class="align-middle">
                    ...
                    <td class="text-start">
                        <form:select path="jnl10DrcrType" class="form-select w-25" required="true"
                        	message="org.springframework.validation.BindingResult.jnl10DrcrType">
                            <form:option value="" />
            ...
            <div class="row justify-content-md-center pt-5">
                ...
                <a href="/jnl/acnt/list" class="btn btn-secondary w-25">취소, 리스트로 돌아감</a>
            </div>
        </form:form>
    </div>
</main>
