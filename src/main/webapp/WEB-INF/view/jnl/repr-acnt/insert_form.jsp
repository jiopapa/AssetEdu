...
<!-- =================================================== -->
<title><c:out value="${pageTitle}" default="대표계정코드-등록" /></title>
</head>
<body>
<!-- =================================================== -->
...
<main class="container mx-3 my-3">
    ...
    <div class="border-top border-2 p-4">
        ...
        <form:form action="${baseUrl }/insert" method="POST" modelAttribute="jnl11ReprAcnt" class="validcheck" >
			<div class="row">
				<div class="col-8">			
		            <table  class="table table-sm table-borderless" >
		                 <tr class="align-middle">
		                    ...
		                    <td class="text-start">
		                    	<form:input type="text" class="form-control w-25" path="jnl11ReprAcntCd" pattern="\d*" maxlength="4" data-v-min-length="4" required="true"
									title="숫자만 입력해 주세요." />
		                    </td>
		                 </tr>
		                <tr class="align-middle">
            ...
            <div class="row">
                <div class="col-8"><kfs:DisplayErrors modelAttribute="jnl11ReprAcnt"/></div>
                <div class="col-4"></div>
            </div>
