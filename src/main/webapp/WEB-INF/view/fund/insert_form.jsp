...
<body>
	...
	<main class="container mx-3 my-3">
		...
		<h2>
			<i class="fa-solid fa-cube my-3"></i> 펀드정보관리 > 펀드정보등록
		</h2>
		<div class="border-top border-2 p-4">

			<form:form action="/fund/insert" method="POST" modelAttribute="fund"
				class="validcheck">
				<table class="table table-sm table-borderless">
					<tr class="align-middle">
						<td class="text-end" style="width: 130px">펀드코드/명</td>
						<td class="w-25"><form:input type="text" class="form-control"
								path="fnd01FundCd" data-v-max-length="4" data-v-min-length="4"
								required="true" placeholder="필수 입력(4자리)" /></td>
						<td colspan="4"><form:input type="text" class="form-control"
								path="fnd01FundNm" required="true" placeholder="펀드명 필수 입력" /></td>
					</tr>
					<tr class="align-middle">
						<td class="text-end">예탁원코드</td>
						<td class="w-25"><form:input type="text" class="form-control"
								path="fnd01KsdItemCd" data-v-max-length="12" placeholder="입력" /></td>
						<td style="width: 50px">&nbsp;</td>
						<td class="text-end">설정일자</td>
						<td><form:input type="text"
								class="form-control w-50 dateinput" path="fnd01StartDate" /></td>
						<td style="width: 50px">&nbsp;</td>
					</tr>
					<tr class="align-middle">
						<td class="text-end">협회표준코드</td>
						<td class="w-25"><form:input type="text" class="form-control"
								path="fnd01KofiaCd" data-v-max-length="12" placeholder="입력" /></td>
						<td style="width: 50px">&nbsp;</td>
						<td class="text-end">해지일자</td>
						<td><form:input type="text"
								class="form-control w-50 dateinput" path="fnd01EndDate" /></td>
						<td style="width: 50px">&nbsp;</td>
					</tr>
					<tr class="align-middle">
						<td class="text-end">금감원코드</td>
						<td class="w-25"><form:input type="text" class="form-control"
								path="fnd01FssCd" data-v-max-length="12" placeholder="입력" /></td>
						<td style="width: 50px">&nbsp;</td>
						<td class="text-end">최초결산일자</td>
						<td><form:input type="text"
								class="form-control w-50 dateinput" path="fnd01FirstCloseDate" /></td>
						<td style="width: 50px">&nbsp;</td>
					</tr>
					<tr class="align-middle">
						<td class="text-end">펀드유형</td>
						<td class="w-25"><form:select path="fnd01FundType"
								class="form-select">
								<option value="" disabled selected />선택</option>
								<form:options items="${fnd01FundTypeNmList}"
					...
					<tr class="align-middle">
						...
						<td class="w-25"><form:select path="fnd01PublicCd"
								class="form-select">
								<option value="" disabled selected />선택</option>
								<form:options items="${PublicCodeList}" itemValue="com02DtlCd"
									itemLabel="com02CodeNm" />
							</form:select></td>
						<td style="width: 50px">&nbsp;</td>
						<td class="text-end">주 운용역</td>
						<td><form:input type="text" class="form-control"
								path="fnd01Manager" /></td>
						<td style="width: 50px">&nbsp;</td>
					</tr>
					<tr class="align-middle">
						<td class="text-end">펀드단위</td>
						<td class="w-25"><form:select path="fnd01UnitCd"
								class="form-select">
								<option value="" disabled selected />선택</option>
								<form:options items="${FundUnitCodeList}" itemValue="com02DtlCd"
									itemLabel="com02CodeNm" />
							</form:select></td>
						<td style="width: 50px">&nbsp;</td>
						<td class="text-end">부 운용역</td>
						<td><form:input type="text" class="form-control"
								path="fnd01SubManager" /></td>
						<td style="width: 50px">&nbsp;</td>
					</tr>
					<tr class="align-middle">
						...
						<td><form:hidden path="fnd01MngCoCd" /> <form:input
								type="text" class="form-control bg-light" path="fnd01MngCoNm"
								readonly="true" /></td>
						<td><button class="btn btn-primary" id="btnPopupMngCo">
					...
					<tr class="align-middle">
						...
						<td><form:hidden path="fnd01TrustCoCd" /> <form:input
								type="text" class="form-control bg-light" path="fnd01TrustCoNm"
								readonly="true" /></td>
						<td><button class="btn btn-primary" id="btnPopupTrustCo">
								<i class="fa-solid fa-search"></i>
							</button></td>
					</tr>
					<tr class="align-middle">
						...
						<td><form:hidden path="fnd01OfficeCoCd" /> <form:input
								type="text" class="form-control bg-light" path="fnd01OfficeCoNm"
								readonly="true" /></td>
						<td><button class="btn btn-primary" id="btnPopupOfficeCo">
								<i class="fa-solid fa-search"></i>
							</button></td>
					</tr>
				</table>
				...
				<div class="row justify-content-md-center pt-5">
					...
					<a href="/fund/list" class="btn btn-secondary w-25">취소, 리스트로
						돌아감</a>
				</div>
