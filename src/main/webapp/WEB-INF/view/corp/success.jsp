...
<main class="container mx-3 my-3">
	...
	<h2><i class="fa-solid fa-cube my-3"></i> 기관정보 > <c:if test="${mode eq 'insert'}">기관정보등록 SUCCESS</c:if>
													   <c:if test="${mode eq 'update'}">기관정보수정 완료</c:if>	</h2>
		...
		<div>
			...
			<td>
				<c:if test="${mode eq 'insert'}">
					<a href="/corp/insert" class="btn btn-warning">계속입력</a>
				</c:if>
