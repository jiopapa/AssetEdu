        ...
        <form:form action="/corp/update" method="POST" modelAttribute="corp" class="validcheck" >
            <table class="table table-sm table-borderless">
                <tr class="align-middle">
                    ...
                    <td><form:input type="text" class="form-control w-25 bg-light" path="com01CorpCd" readonly="true" /></td>
                </tr>
                <tr class="align-middle">
                ...
                <tr class="align-middle">
                    ...
                    <td><form:input type="text" class="form-control" path="com01CorpEnm" data-v-max-length="100" pattern="[a-zA-Z,\.\&]+" title="영문과 특수문자(, . &)만 입력하세요."/></td>
                </tr>
                <tr class="align-middle">
                ...
                <tr class="align-middle">
                    ...
                    <td><form:input type="text" class="form-control w-25" pattern="[0-9]+" maxlength ="5" title="숫자(5자 이하)만 입력해 주세요" path="com01ExtnCorpCd" /></td>
                </tr>
            </table>
