...
<body>
	...
	<main class="container mx-3 my-3">
		...
		<h2>
			<i class="fa-solid fa-cube my-3"></i> USER LIST
		</h2>
		...
		<div class="container-lg p-3 border border-2 rounded-1">
			<input type="text" class="form-control w-25 d-inline align-middle"
				...
				class="fa-solid fa-backspace"></i> 초기화</a> <a
				class="btn d-inline align-middle btn-success"
				href="/admin/user/insert"> <i class="fa-solid fa-user-plus"></i>
				등록
			</a>
		</div>

		<table class="table table-sm table-hover mt-3 userTable"
		...
		$(document).ready(
				function() {
					...
					$('.btnRetrieve').on('click', function() {
						...
						AssetUtil.submitGet('/admin/user/list', {
					...
					$('.btnModify').on('click', function() {
						...
						AssetUtil.submitGet('/admin/user/update', {
							sys01UserId : userId
						});
					})
					$('.btnDelete').on('click', function() {
						...
						if (confirm("사용자 " + userNm + "을(를) 삭제하시겠습니까?")) {
							AssetUtil.submitGet('/admin/user/delete', {
								sys01UserId : userId
							});
						}
					})
...
function go(pageNo){
	...
	console.log("goPage");
	AssetUtil.submitGet('/admin/user/list', {searchText: searchText, currentPageNo : pageNo, pageSize: pageInfo} );
}
</script>	
<script>
  $(function() {
