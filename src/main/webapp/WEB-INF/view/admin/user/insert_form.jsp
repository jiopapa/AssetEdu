...
<main class="container mx-3 my-3">
	...
	<div class="border-top border-2 p-4">
        ...
        <form:form action="/admin/user/insert" method="POST" modelAttribute="user" class="validcheck" >
          ...
          <div class="mb-3">
            <label for="sys01UserTel" class="form-label">유저 전화번호</label>
            <input type="Tel" class="form-control" id="sys01UserTel" name="sys01UserTel" required data-v-equal="#sys01UserTel" />
          </div>
          <div class="mb-3">
            <label for="sys01UserEmail" class="form-label">유저 이메일</label>
            <input type="email" class="form-control" id="sys01UserEmail" name="sys01UserEmail"  />
          </div>
